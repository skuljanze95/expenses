...
import { addRecurringTransaction } from "@/lib/actions/recurring-transation/add-recurring-transaction";
import {
  type CategoryType,
  transactionType,
...
export function AddRecurringTransactionDrawer({ categories }: Props) {
  ...
  async function handleAddNewRecurringTransaciton(
        ...
        <div className="mx-auto max-w-md p-4">
          ...
          <Form {...form}>
            <form
              ...
              onSubmit={form.handleSubmit(handleAddNewRecurringTransaciton)}
            >
              <FormField
